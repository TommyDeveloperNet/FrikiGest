...
namespace ConnBBDD
{
    ...
    /// <summary>
    /// Clase que gestiona la conexión a base de datos así como las operaciones de select / insert / udpate y delete para una base de datos mediante ODBC
    /// </summary>
    public class ConnectionODBC : IDisposable
    {
        //--------------------------------------------------------------------
        ...
        public ConnectionODBC(OdbcConnection objConnection)
        {
        ...
        public List<T> Select<T>(string sTable_View_Name, string sqlCommand = "")
        {
            ...
            OdbcCommand objComando = new OdbcCommand();
            OdbcDataAdapter objAdaptador = null;
            ...
            try
            {
                objAdaptador = new OdbcDataAdapter(objComando.CommandText, objComando.Connection);
            }
            catch (Exception ex)
            {
                //ERROR!!!!!
        ...
        public bool Update<T>(string sTable_View_Name, T objDatosUpdate, int IDUpdate, string sFieldID = "ID")
        {
            ...
            {
                objComando.Parameters.AddWithValue("", Parameter.sValue);
            }
